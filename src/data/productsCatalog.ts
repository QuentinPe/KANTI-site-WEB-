    ...
    products: [
      ...
      },
      {
        ...
        benefits: [
          ...
          "Arbitrage entre patrimoine immobilier et liquidités",
      ...
      },
      {
        ...
        benefits: [
          "Structuration des flux entre société mère et filiales, selon le cadre fiscal applicable",
          "Intégration fiscale possible",
          "Optimisation des remontées de dividendes",
          "Préparation Pacte Dutreil",
          "Préparation de la transmission et stratégies de démembrement",
        ],
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        fiscality: "Régime mère-fille. Intégration fiscale optionnelle.",
      },
      {
    ...
    products: [
      {
        ...
        benefits: [
          "Abattements par bénéficiaire, selon les règles fiscales en vigueur",
          "Valeurs figées au jour de la donation",
          "Évite les rapports successoraux",
          "Acte authentique sécurisé",
        ],
        fiscality: "Abattements renouvelables selon la périodicité légale applicable au moment de l'opération. Barème progressif des droits de donation.",
      },
      {
        slug: "demembrement",
        tag: "Démembrement",
      ...
      },
      {
        ...
        benefits: [
          "Des abattements spécifiques par bénéficiaire, selon l'âge du souscripteur au moment des versements",
          "Clause bénéficiaire sur mesure",
          "Hors masse successorale",
          "Démembrement de la clause possible",
        ],
        fiscality: "Fiscalité spécifique hors succession, selon le cadre légal applicable aux versements et à l'âge du souscripteur. Vérifiée au moment de la recommandation.",
      },
      {
        slug: "pacte-dutreil",
        tag: "Entreprise",
        title: "Pacte Dutreil",
        pitch: "Transmettre l'entreprise familiale dans des conditions fiscales optimisées.",
        forWhom: "Dirigeants envisageant la transmission familiale de leur société.",
        benefits: [
          "Exonération partielle de l'assiette taxable",
          "Cumul avec donation en pleine ou nue-propriété",
          "Réduction complémentaire sous conditions d'engagement",
          "Engagement collectif puis individuel",
        ],
        fiscality: "Engagement collectif puis individuel de conservation des titres, selon les durées légales en vigueur.",
      },
      {
