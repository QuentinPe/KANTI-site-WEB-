...
const faqCategories = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Le rendez-vous peut-il se faire à distance ?", a: "Oui. Nous recevons nos clients dans nos locaux au cœur de Biarritz, mais nous réalisons également des rendez-vous en visioconférence pour les clients éloignés ou les expatriés." },
  ...
  },
  {
    ...
    questions: [
      { q: "Mes informations restent-elles confidentielles ?", a: "Oui, sans condition. Nous sommes soumis au secret professionnel CIF et au code de déontologie de la CNCEF. Aucune donnée n'est partagée avec un tiers, y compris vos autres conseils, sans votre accord écrit." },
