          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-foreground/65 font-light leading-relaxed max-w-xl mx-auto mb-12">
              {isResource
                ...
                : "Un conseiller KANTI prend connaissance de votre message et vous recontacte sous 24 heures ouvrées. Pour les demandes urgentes, vous pouvez nous joindre directement au 05 56 00 00 00."}
            </p>
