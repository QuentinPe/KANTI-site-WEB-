...
const faqs = [
  ...
  },
  {
    ...
    a: "Oui, en tant que CIF sous contrôle des autorités financières compétentes et adhérent de la CNCEF, nous sommes soumis à un strict devoir de confidentialité et à un code de déontologie. Aucune information ne sort du cabinet sans votre accord explicite.",
  },
];
