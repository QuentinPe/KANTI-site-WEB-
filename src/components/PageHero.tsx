...
export default function PageHero({
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden section-dark">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-36 pb-20 w-full text-center">
        {breadcrumb && (
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-dark mb-10 text-xs text-white/65 tracking-wide">
        ...
        <p className="text-[10px] tracking-[0.32em] uppercase text-white/55 mb-7 font-medium">
          {eyebrow}
        </p>
        <h1 className="text-4xl md:text-5xl lg:text-[68px] font-heading font-light text-white leading-[1.05] mb-8 tracking-tight text-balance">
          {title}
          {highlight && (
            <>
              <br />
        ...
        <p className="text-base md:text-lg text-white/65 max-w-2xl mx-auto leading-relaxed font-light">
          {subtitle}
        </p>

        {stats && stats.length > 0 && (
          <div className="mt-14 grid grid-cols-3 gap-6 max-w-2xl mx-auto border-t border-white/10 pt-10">
            {stats.map((s) => (
              <div key={s.label}>
