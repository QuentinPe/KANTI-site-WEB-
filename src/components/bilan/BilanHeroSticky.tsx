...
const STATS = [
  ...
  { value: "Écrit", label: "Remis en main propre" },
];

const CONTACT_URL = "/contact";
const GESTION_URL = "/gestion-patrimoniale";

export default function BilanHeroSticky() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={IMAGE_URL}
          alt="Bilan patrimonial KANTI Bordeaux"
        ...
        <div className="max-w-6xl mx-auto px-8 md:px-14 w-full">
          <div className="max-w-xl">
            ...
            >
              Votre patrimoine,
              <br />
              <span className="italic text-white/65">lu dans son ensemble.</span>
            </h1>
