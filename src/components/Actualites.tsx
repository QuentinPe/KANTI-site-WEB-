...
export default function Actualites() {
  ...
  return (
    <section
      id="actualites"
      className="section-padding section-glass texture-paper relative [overflow:clip]"
    >
      {/* Glow décoratif */}
      <div
        aria-hidden
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          ...
          {/* En-tête sticky */}
          <aside className="lg:col-span-4 lg:sticky lg:top-32 lg:self-start mb-6 lg:mb-0">
            <p className="text-[11px] font-medium tracking-[0.28em] uppercase text-foreground/50 mb-5">
            ...
            <p className="text-foreground/60 text-base font-light leading-relaxed mb-8 max-w-sm">
              Points de marché et décryptages · pour prendre les meilleures décisions au bon moment.
            </p>
            <Link
              to="/actualites"
              data-magnetic
