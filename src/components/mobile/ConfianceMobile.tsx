const badges = [
  { label: "ORIAS", title: "CIF · COA · COBSP", body: "Inscrit comme Conseiller en Investissements Financiers et Courtier en Assurances." },
  { label: "CNCGP", title: "Membre certifié", body: "Code de déontologie strict, formation continue et contrôle annuel." },
